...
/**
 * KATA 11: Tungsten Engine - SOLUTION
 */
object Solution extends App {

  println("=" * 60)
  println("KATA 11: Tungsten Engine - SOLUTION")
  println("=" * 60)
  ...
  println(s"\n✓ Exercise 4: ${internalRDD.first().getClass.getName}")
  ...
  spark.stop()
  println("\n" + "=" * 60)
  println("KATA 11 SOLUTION COMPLETE!")
  println("=" * 60)
}
